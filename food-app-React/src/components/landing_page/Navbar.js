...
//   const { user } = useUser();
//   const userName = user ? user.userName : ''; // Safe check for user

//   const imageFile=user ? user.imageFileName : '';
...
//                     <Button
//                       sx={{ backgroundColor: '#F9A01A', boxShadow: 'none', fontWeight: 'bold' }}
//                       variant="contained"
//                       component={Link}
//                       to="/Owner-signup"
//                     >
...
//             >
//               {isLoggedIn ? `Hi, ${userName} (Logout)` : 'Login'}
//               </Button>
//               </>
//             )}
...
//               <IconButton sx={{ p: 0 }}>
//               <Avatar src={`http://localhost:8080/profile-image/${imageFile}`} alt={userName}  />
//               </IconButton>
//             </Tooltip>
//           </Box>
//           )}
